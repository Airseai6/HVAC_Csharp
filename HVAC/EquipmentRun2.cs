...
namespace HVAC
{
    class EquipmentRun2
    {
        ...
        /// <param name="_冷水机组_冷却水进口水温"></param>
                                ...
                                ref float _系统_COP )
        {
            ...
            _冷冻水泵_流量 = _建筑总冷负荷 / (4.17f * 1000 * 5) * 3600 / _冷冻水泵_运行台数;
