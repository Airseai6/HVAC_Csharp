    ...
    public class EquipmentRun4_空气源热泵
    {
                                ...
                                )
        {
            ...
            if (ISCan_机组均启动 && _建筑总冷负荷 > 0)
            {
                    ...
                    case 0:
                        {
                            ...
                            _冷冻水泵扬程_变化 = (_冷冻水泵_流量 / _冷冻水流量_最大值 * _冷冻水泵_运行台数) * (_冷冻水泵_流量 / _冷冻水流量_最大值 * _冷冻水泵_运行台数) * _冷冻水泵_扬程;
                ...
                _冷冻水泵_运行功率 = 1000 * 9.81f * _冷冻水泵_流量 * _冷冻水泵扬程_变化 / 3600 / 1000 / 10 / 0.75f;
                // _冷冻水泵_运行频率 = 50 * _冷水机组_制冷量 /_冷水机组_额定制冷量;



                _冷水机组_冷冻水进口压力 = _冷冻水泵_出口压力 - 3 * (_冷冻水泵_流量 * _冷冻水泵_运行台数 / _冷冻水流量_最大值) * (_冷冻水泵_流量 * _冷冻水泵_运行台数 / _冷冻水流量_最大值);
                ...
                float _负荷率_修正 = _冷冻水泵_流量 * _冷冻水泵_运行台数 / _冷冻水流量_最大值;
                _冷水机组_COP = _冷水机组_COP_修正 * (-1.0009f * _负荷率_修正 * _负荷率_修正 * _负荷率_修正 + 0.3945f * _负荷率_修正 * _负荷率_修正 + 1.4007f * _负荷率_修正 + 0.2105f);
